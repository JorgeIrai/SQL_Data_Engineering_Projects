...
UNION
SELECT 'skills_dim' AS table_name, COUNT(*) FROM skills_dim
UNION
SELECT 'job_postings_fact' AS table_name, COUNT(*) FROM job_postings_fact
UNION
SELECT 'skills_job_dim' AS table_name, COUNT(*) FROM skills_job_dim;
