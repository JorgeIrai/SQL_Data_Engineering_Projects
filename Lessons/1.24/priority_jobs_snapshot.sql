...
-- UPDATE Statement: To capture the diferences in the rows that match in src and tgt
UPDATE main.priority_jobs_snapshot AS tgt
SET
    priority_lvl = src.priority_lvl,
    updated_at = src.updated_at
FROM
    src_priority_jobs src
WHERE
...
-- DELETE: Unmatched Existing Rows in the target table
